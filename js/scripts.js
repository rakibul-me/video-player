...
function formatTime(timeInSeconds) {
    return {
        minutes: Math.floor(timeInSeconds / 60) > 9 ? Math.floor(timeInSeconds / 60) : `0${Math.floor(timeInSeconds / 60)}`,
        seconds: (timeInSeconds - Math.floor(timeInSeconds / 60) > 9 ? timeInSeconds - Math.floor(timeInSeconds / 60) : `0${timeInSeconds - Math.floor(timeInSeconds / 60)}`).toString().slice(0, 2),
    }
}
